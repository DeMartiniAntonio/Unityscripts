...
using Assets.ImStriker.Scripts.Others.Utilities;
using Assets.ImStriker.Scripts.States.GoalKeeperStates.Dive.MainState;
using RobustFSM.Base;
using UnityEngine;

namespace Assets.ImStriker.Scripts.States.GoalKeeperStates.InterceptShot.MainState
{
    public class InterceptShotMainState : BState
    {
        ...
        public override void Enter()
        {
            ...
            _playerInterceptPoint = _orthogonalPointToPlayerPositionOnBallPath = OrthogonalPoint.OrthPoint(_normalizedBallInitialPosition, _normalizedBallTarget, Owner.Position, Owner.Ball.Rigidbody.angularVelocity);
            ...
            Owner.RPGMovement.Speed = playerDiveSpeed + 0.1f;
            if (_ballPositionAtPlayerOrthogonalPoint.y < 0.15)
                Owner.RPGMovement.Speed = playerDiveSpeed + 0.5f;
        ...
        public override void Execute()
        {
            ...
            float ballDistanceToGoal = Vector3.Distance(_normalizedBallPosition, Owner.Position);

            if (ballDistanceToGoal < 20f)
            {
        ...
        public override void OnAnimatorMove()
        {
            ...
            Vector3 localPosition = new(Owner.ModelRoot.transform.localPosition.x, 0f, Owner.ModelRoot.transform.localPosition.z);

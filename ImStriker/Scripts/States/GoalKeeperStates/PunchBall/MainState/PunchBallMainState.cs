...
namespace Assets.ImStriker.Scripts.States.GoalKeeperStates.Dive.MainState
{
    public class PunchBallMainState : BState
    {
        ...
        public override void Enter()
        {
            ...
            if (_ballTrapable)
            {
                ...
                Owner.Ball.Rigidbody.linearVelocity = 0.5f * Owner.Ball.Rigidbody.linearVelocity.magnitude * ballPunchDirection;
            }
